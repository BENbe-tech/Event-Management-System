        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="{{ route('organizerpay') }}" method="post" class="validation"
                     ...
                     <p><a href="organizer-payindex2">pay via Mobile money</a> </p>
                        ...
                        <div class='form-row row'>
                         ...
                         <div class='col-xs-12 form-group required'>
                            ...
                            <input type = "text" class = "form-control amount" placeholder="5000" name="amount" id="amount" value="{{old('amount')}}" required>
...
{{--
                        <div class='form-row row'>
                            <div class='col-xs-12 form-group required'>
                                <label class='control-label' >Amount</label> <input
                                    class='form-control amount'  name="amount" placeholder='in Tsh' type='text' required>
                            </div>
                        </div> --}}
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 form-group required'>
                                <label class='control-label'>Name on Card</label> <input
                                    class='form-control' size='4' type='text' name = "card">
                            </div>
                        </div>
                        ...
                        <p>Yearly Subscription:<b>60000</b></p>
                        <p>Monthly Subscription:  <b>5000</b></p>
